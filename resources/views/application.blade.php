    ...
    <div class="container">
        ...
        <div class="row d-flex justify-content-center">
            <p class="lead display-4">
                State Department for Planning - Internship
            </p>
        </div>
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-center">Application Requirements</div>
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">&bull; A working email address. - This shall be used as your primary address</li>
                            <li class="list-group-item">&bull; A scanned copy of your National ID or Passport</li>
                            <li class="list-group-item">&bull; A scanned copy of your  Academic Certificates</li>
                            <li class="list-group-item">&bull; A scanned copy of your Letter form the institution</li>
                            <li class="list-group-item">&bull; A scanned copy of your Insurance cover</li>
                            <li class="list-group-item">&bull; A scanned copy of your Introduction letter</li>
                            <li class="list-group-item">&bull; A scanned copy of your Certificate of conduct</li>
                            <li class="list-group-item">&bull; A scanned copy of your Curriculum Vitae (CV)</li>
                        </ul>
                    </div>
                </div>
            </div>
